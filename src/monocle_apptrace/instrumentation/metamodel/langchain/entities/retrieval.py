        ...
        [
            {
                ...
                "attribute": "name",
                "accessor": lambda arguments: type(
                    arguments["instance"].vectorstore
                ).__name__,
            },
            {
                "attribute": "type",
                "accessor": lambda arguments: "vectorstore."
                + type(arguments["instance"].vectorstore).__name__,
            },
            {
        ...
        [
            {
                ...
                "accessor": lambda arguments: _helper.resolve_from_alias(
                    arguments["instance"].vectorstore.embeddings.__dict__,
                    ["endpoint_name", "model_id", "model"],
                ),
            },
            {
                "attribute": "type",
                "accessor": lambda arguments: "model.embedding."
                + _helper.resolve_from_alias(
                    arguments["instance"].vectorstore.embeddings.__dict__,
                    ["endpoint_name", "model_id", "model"],
                ),
            },
