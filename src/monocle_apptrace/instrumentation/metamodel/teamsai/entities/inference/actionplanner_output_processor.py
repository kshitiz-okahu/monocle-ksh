        ...
        [
            ...
            },
            {
                ...
                "accessor": lambda arguments: (
                    arguments["instance"]._options.max_repair_attempts
                    if hasattr(arguments["instance"], "_options")
                    else 3
                ),
            },
        ],
        [
            {
                ...
                "attribute": "model",
                "accessor": lambda arguments: (
                    arguments["instance"]._options.model.__class__.__name__
                    if hasattr(arguments["instance"], "_options")
                    else "unknown"
                ),
            },
            {
                "attribute": "tokenizer",
                "accessor": lambda arguments: (
                    arguments["instance"]._options.tokenizer.__class__.__name__
                    if hasattr(arguments["instance"], "_options")
                    else "GPTTokenizer"
                ),
            },
            ...
            "attributes": [
                {
                    ...
                    "accessor": lambda arguments: _helper.get_prompt_template(
                        arguments
                    ),
                },
                {
                    "attribute": "validator",
                    "accessor": lambda arguments: (
                        arguments["kwargs"].get("validator").__class__.__name__
                        if arguments.get("kwargs", {}).get("validator")
                ...
                },
                {
                    ...
                    "accessor": lambda arguments: (
                        arguments["kwargs"].get("memory").__class__.__name__
                        if arguments.get("kwargs", {}).get("memory")
                        else "unknown"
                    ),
                },
            ],
            ...
            "attributes": [
                {
                    ...
                    "accessor": lambda arguments: {
                        ...
                        "feedback_enabled": (
                            arguments["instance"]._enable_feedback_loop
                            if hasattr(arguments["instance"], "_enable_feedback_loop")
                            else False
                        ),
                    },
                }
