    ...
    "attributes": [
        [
            ...
            },
            {
                ...
                "accessor": lambda arguments: arguments["kwargs"].get("provider_name")
                or _helper.extract_provider_name(arguments["instance"]),
            },
            {
            ...
            },
            {
                ...
                "accessor": lambda arguments: resolve_from_alias(
                    arguments["instance"].__dict__, ["azure_endpoint", "api_base"]
                )
        ...
        [
            {
                ...
                "attribute": "name",
                "accessor": lambda arguments: resolve_from_alias(
                    arguments["instance"].__dict__, ["model", "model_name"]
                ),
            },
            {
                "attribute": "type",
            ...
            "attributes": [
                {
                    ...
                    "accessor": lambda arguments: _helper.update_span_from_llm_response(
                        arguments["result"], arguments["instance"]
                    ),
                }
            ],
        },
