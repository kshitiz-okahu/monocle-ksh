        ...
        [
            {
                ...
                "accessor": lambda arguments: type(
                    arguments["instance"]._vector_store
                ).__name__,
            },
            {
                "attribute": "type",
                "accessor": lambda arguments: "vectorstore."
                + type(arguments["instance"]._vector_store).__name__,
            },
            {
        ...
        [
            {
                ...
                "attribute": "name",
                "accessor": lambda arguments: arguments[
                    "instance"
            ...
            },
            {
                ...
                + arguments["instance"]._embed_model.model_name,
            },
        ],
    ],
    "events": [
