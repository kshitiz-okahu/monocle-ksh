    ...
    "attributes": [
        [
            ...
            },
            {
                ...
                "attribute": "name",
                "accessor": lambda arguments: _helper.get_agent_name(
                    arguments["instance"]
                ),
            },
            {
                ...
                "accessor": lambda arguments: _helper.get_agent_description(
                    arguments["instance"]
                ),
            },
        ]
            ...
            "attributes": [
                {
                    ...
                    "attribute": "input",
                    "accessor": lambda arguments: _helper.extract_agent_request_input(
                        arguments["kwargs"]
                    ),
                }
            ],
            ...
            "attributes": [
                {
                    "_comment": "this is response from LLM",
                    "attribute": "response",
                    "accessor": lambda arguments: _helper.extract_agent_request_output(
                        arguments
                    ),
                }
            ],
    ...
    "attributes": [
        [
            ...
            },
            {
                ...
                "attribute": "to_agent",
                "accessor": lambda arguments: _helper.get_target_agent(
                    arguments["result"]
                ),
            },
        ]
